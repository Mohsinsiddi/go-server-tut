...
mock:
	mockgen --package mockdb --destination db/mock/store.go github.com/Mohsinsiddi/simplebank/db/sqlc Store	
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/Mohsinsiddi/simplebank/worker TaskDistributor
